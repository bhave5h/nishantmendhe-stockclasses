  ...
  if (isSuccess) {
    return (
      <motion.div
        ...
        className="bg-green-50 text-green-800 p-6 md:p-10  rounded-2xl border border-green-200 flex flex-col items-center justify-center text-center h-full min-h-[400px]"
      >
            ...
            <FormItem>
              ...
              <FormControl>
                <Input
                  ...
                  className="bg-white border-neutral-200 focus-visible:ring-blue-500 rounded-xl h-12"
                  {...field}
                />
              </FormControl>
