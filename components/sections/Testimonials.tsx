    ...
    <section id="testimonials" className="w-full bg-white py-24 md:py-15 z-10">
      <div className="max-w-[1000px] mx-auto px-4 md:px-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-4 md:mb-10">
          ...
          >
            Thousands of learners have taken their first confident step into
            stock trading with our guidance. Here’s what they have to say about
            their journey.
          </motion.p>
        </div>
          ...
          {testimonials.map((t, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-2">
                <div className="w-15 h-15 rounded-full overflow-hidden flex-shrink-0 border border-gray-200">
                  <img
                    src={t.source}
                    alt={t.name}
                ...
                <div>
                  <p className="text-m font-semibold text-[#0F172A]">
                    {t.name}
                  </p>
                  <p className="text-s text-gray-400">{t.role}</p>
                </div>
              </div>

              <p className="text-[15px] text-neutral-600 font-semibold leading-relaxed mb-4">
                &ldquo;{t.text}&rdquo;
              </p>
